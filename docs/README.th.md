...
`omnicross` รับคำขอ LLM ขาเข้า — OpenAI `/v1/chat/completions`, Anthropic `/v1/messages`, Gemini และอื่น ๆ — จากนั้นตัดสินว่า**ผู้ให้บริการ บัญชี และคีย์ใด**ควรรับผิดชอบ (คีย์ API ของคุณเอง, พูลคีย์หลายตัว, หรือตัวตน OAuth ของการสมัครสมาชิก) แล้วส่งผ่านท่อ transformer + auth และพร็อกซีไปยังต้นทาง — จากนั้นเข้ารหัสการตอบสนองกลับเป็นรูปแบบ wire format ที่ผู้เรียกร้องขอ
