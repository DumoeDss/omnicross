...
**omnicross يُشغّل كل تطبيقات الذكاء الاصطناعي وأدوات CLI البرمجية من مكان واحد — باستخدام اشتراكاتك أو مفاتيح API الحالية.**

وجّه Claude Code أو Codex أو Gemini CLI — أو أي تطبيق يتحدث OpenAI / Anthropic / Gemini API — نحو omnicross، وسيوجّه كل طلب إلى المزود والنموذج الذي تختاره. ما يمكنك فعله:

- التشغيل باستخدام **تسجيل دخول اشتراك Claude / ChatGPT / Gemini**، متجاوزاً مفاتيح API المحسوبة بالاستخدام؛
- تجميع مفاتيح API متعددة في **تجمع مفاتيح** مع التناوب التلقائي والتجاوز عند الفشل؛
- تمكين أداة تتحدث تنسيق API واحداً فقط من استدعاء نموذج يتحدث تنسيقاً آخر — إذ يترجم omnicross الطلب والاستجابة في الوقت الفعلي.

كل ذلك يُدار عبر واجهة مستخدم رسومية لسطح المكتب — دون الحاجة إلى تعديل ملفات التكوين يدوياً.
